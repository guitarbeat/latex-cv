...
\definecolor{darkblue}{rgb}{0.0, 0.0, 0.55} % * Accessible link color
\hypersetup{
  colorlinks=true,
  urlcolor=darkblue,
  linkcolor=black,
  ...
  pdfauthor={Aaron Lorenzo Woods}, % * Metadata
  pdfsubject={Curriculum Vitae}, % * Metadata
  pdfkeywords={CV, Resume, Biomedical Engineering, LaTeX}, % * Metadata
  pdflang={en-US}, % * Accessibility: Language tag
  pdfdisplaydoctitle=true, % * UX: Show title instead of filename
