...
\hypersetup{
  ...
  pdfproducer={XeLaTeX},
  pdftitle={Aaron Lorenzo Woods - CV}, % * Accessibility: Document title
  pdfauthor={Aaron Lorenzo Woods}, % * Accessibility: Author metadata
  pdflang={en-US}, % * Accessibility: Language tag
  pdfdisplaydoctitle=true % * Accessibility: Display title in window bar
}
