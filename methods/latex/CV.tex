...
%----------------------------------------------------------------------------------------
% Edit these values to update your CV
\newcommand{\myname}{Aaron Lorenzo Woods}
\newcommand{\myemail}{alwoods@utexas.edu}
\newcommand{\mywebsite}{aaronwoods.info}
\newcommand{\myfootername}{A.L. Woods}
...
\fancyfoot{} % clear
\fancyfoot[R]{\small \myfootername, \thepage}
...
\noindent\begin{tblr}{
  ...
  {\textbf{\myname}} & \raggedleft \myemail \;|\; \mywebsite \\
\end{tblr}
\vspace{1.3ex}
