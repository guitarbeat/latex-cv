...
% Replaced tabularray with tabularx for performance
\usepackage{tabularx}
\usepackage{booktabs}
...
% 3:1 ratio (Total X widths = 2)
\newcolumntype{Y}{>{\hsize=1.5\hsize\raggedright\arraybackslash}X}
\newcolumntype{Z}{>{\hsize=0.5\hsize\raggedleft\arraybackslash}X}
...
% PhD entry
\noindent\begin{tabularx}{\textwidth}{@{}YZ@{}}
...
% Use modern tabularx to align funding and dates
\noindent\begin{tabularx}{\textwidth}{@{}YZ@{}}
...
\noindent\begin{tabularx}{\textwidth}{@{}YZ@{}}
  ...
  \multicolumn{2}{@{}l@{}}{\;Awarded \$2,500 to advance an entrepreneur effort by developing prototypes.}\\
  ...
  \multicolumn{2}{@{}l@{}}{\;Awarded by staff, teachers, and the department chair to one graduating student who exhibits exceptional character.}\\
