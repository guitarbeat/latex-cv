...
\noindent\begin{tblr}{
  ...
  {\textbf{Aaron Lorenzo Woods}} & \raggedleft \href{mailto:alwoods@utexas.edu}{alwoods@utexas.edu} \;|\; \href{https://aaronwoods.info}{aaronwoods.info} \\
\end{tblr}
\vspace{1.3ex}
...
Niemeier, R., N. Schnoor, \textbf{A.L. Woods}, and J.D. Rogers, ``\href{https://doi.org/10.1364/AO.408383}{Calibration of liquid crystal variable retarders using a common-path interferometer and fit of a closed-form expression for the retardance curve},'' published to \textit{Applied Optics}, October 2020.\\[0.8ex]
