...
\fi
% * Efficient table package (replaces tabularray)
\usepackage{tabularx} % * Faster compilation than tabularray
% * Custom column types for tabularx to mimic proportional X columns
% Y is 1.5x width (for 3:1 ratio with Z), Z is 0.5x width
\newcolumntype{Y}{>{\hsize=1.5\hsize}X}
...
% Use tabularx to align funding and dates
\noindent\begin{tabularx}{\textwidth}{@{} Y Z @{}}
