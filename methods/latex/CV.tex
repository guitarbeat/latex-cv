...
\fi
% * Optimized table package (replaces tabularray)
\usepackage{tabularx} % * Faster compilation than tabularray
% Define column types for 3:1 ratio (total 4 parts)
% Standard X is 1/N of total width. For 2 columns, X is 0.5\linewidth.
% Y (3 parts): Needs to be 3/4 \linewidth. So 1.5 * X.
% Z (1 part): Needs to be 1/4 \linewidth. So 0.5 * X.
% We add \raggedright/\raggedleft and \arraybackslash to handle alignment and preserve \\ behavior.
...
\noindent\begin{tabularx}{\textwidth}{@{}X r@{}}
  {\textbf{Aaron Lorenzo Woods}} & \begin{tabular}[t]{@{}r@{}}alwoods@utexas.edu \;|\; aaronwoods.info\end{tabular}
\end{tabularx}
\vspace{1.3ex}
...
\begin{tabularx}{\textwidth}{@{}Y Z@{}}
  ...
  \multicolumn{2}{@{}p{\textwidth}@{}}{\;Awarded \$2,500 to advance an entrepreneur effort by developing prototypes.}\\[0.4ex]
  ...
  \multicolumn{2}{@{}p{\textwidth}@{}}{\;Awarded by staff, teachers, and the department chair to one graduating student who exhibits exceptional character.}\\[0.4ex]
  ...
  \textbf{College of Engineering Dean's List}, University of Texas at El Paso & 2016 -- 2018\\[0.4ex]
\end{tabularx}
