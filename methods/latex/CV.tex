...
\else
  ...
  % Prefer Calibri if available; otherwise force Carlito (Calibri-compatible)
  \IfFontExistsTF{Calibri}{%
    \setmainfont{Calibri}%
    \IfFontExistsTF{Calibri Light}{\newfontfamily\HeadingFace{Calibri Light}}{\newfontfamily\HeadingFace{Calibri}}%
  }{%
    % Use Carlito by explicit file names from user fonts
    \setmainfont[
      Path = /Users/aaron/Library/Fonts/,
      UprightFont = *-Regular.ttf,
      BoldFont = *-Bold.ttf,
      ItalicFont = *-Italic.ttf,
      BoldItalicFont = *-BoldItalic.ttf
    ]{Carlito}
    \newfontfamily\HeadingFace[
      Path = /Users/aaron/Library/Fonts/,
      UprightFont = *-Regular.ttf,
      BoldFont = *-Bold.ttf
    ]{Carlito}
