...
\hypersetup{
  ...
  pdfproducer={XeLaTeX},
  pdftitle={Curriculum Vitae}, % * Accessibility: Document title
  pdfauthor={Aaron Lorenzo Woods}, % * Metadata: Author
  pdfsubject={Academic CV}, % * Metadata: Subject
  pdfkeywords={Biomedical Engineering, Imaging Science, Research, CV}, % * Metadata: Keywords
  pdflang={en-US}, % * Accessibility: Language for screen readers
  pdfdisplaydoctitle={true} % * Accessibility: Display title instead of filename
}
